      ...
      child: Column(
        ...
        children: [
          TextFormField(
            ...
            style: titleTextStyle.copyWith(color:Get.isDarkMode?Colors.white:Colors.grey, ),
            cursorColor: Get.isDarkMode?Colors.white:bgColor,
            maxLines: 3,
            minLines: 1,
            decoration: InputDecoration(
              ...
              focusedBorder: UnderlineInputBorder(
                borderSide: BorderSide(color:Get.isDarkMode?bgColor:Colors.white),
              ),
          ...
          TextFormField(
            ...
            style: titleTextStyle.copyWith(color:Get.isDarkMode?Colors.white:bgColor, ),
            cursorColor: Get.isDarkMode?Colors.white:bgColor,
            minLines: 3,
            maxLines: 12,
            decoration: InputDecoration(
              hintText: "Type something...",
              hintStyle: bodyTextStyle.copyWith(color:Get.isDarkMode?Colors.white:bgColor),
              focusedBorder: UnderlineInputBorder(
                borderSide: BorderSide(color:Get.isDarkMode?bgColor:Colors.white),
              ),
              enabledBorder: UnderlineInputBorder(
  ...
  _addNoteToDB() async {
    await _noteController.addNote(
      note: Note(
        ...
        date: DateFormat.yMd().format(_currentDate).toString(),
      ),
    );
  }
